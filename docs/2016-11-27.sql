...
CREATE TABLE IF NOT EXISTS `resu_location_menu` (
  ...
  `high_price` VARCHAR(6) NULL DEFAULT NULL,
  `low_price` VARCHAR(6) NULL DEFAULT NULL,
  `created_at` INT(11) NULL DEFAULT NULL,
  `created_by` INT(11) NOT NULL,
  `updated_at` INT(11) NULL DEFAULT NULL,
  `updated_by` INT(11) NULL DEFAULT NULL,
...
SHOW WARNINGS;
CREATE UNIQUE INDEX `id_UNIQUE` ON `resu_review` (`id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_resu_review_resu_location1_idx` ON `resu_review` (`resu_location_id` ASC);
