...
SHOW WARNINGS;
CREATE UNIQUE INDEX `id_UNIQUE` ON `resu_location_alcohol` (`id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_resu_location_alcohol_resu_alcohol_option1_idx` ON `resu_location_alcohol` (`resu_alcohol_option_id` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_resu_location_alcohol_resu_location1_idx` ON `resu_location_alcohol` (`resu_location_id` ASC);
